...
public class BookingService {
    ...
    public BookingDTO createBooking(BookingRequest request) {
        ...
        // WHY synchronized on slot object: Prevents race conditions
        // SCENARIO: Two users try to book last slot simultaneously
        // Without sync: Both might succeed (overbooking!)
        // With sync: Second user gets "slot full" error
        synchronized (slot) {
            ...
            // WHY method on entity: Business logic lives in entity
        ...
        Booking booking = new Booking(
            user,
            slot,
            LocalDateTime.now(),  // When booking was made
